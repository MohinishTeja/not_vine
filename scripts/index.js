 ...
 (function webpackUniversalModuleDefinition(root, factory) {
  ...
  function upload() {
    ...
    reader.onloadend = function() {
      ...
      ipfs.add(base64buf, (err, result) => { // Upload buffer to IPFS
        ...
        let hashBtn = document.getElementById("type");
        hashBtn.value = url;
        console.log(`Url --> ${url}`)
      })
    }
  ...
  function download(ipfs_ff,imageElement) {
...
function createPost(hash,info,name) {
...
if(name=="Mohinish"){
  imageElementn.src="img/mohinish.jpg"
    ...
    postb.append(imageElement,likesp,captionp);
